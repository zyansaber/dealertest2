  ...
  return (
    <>
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="mb-2 text-sm font-semibold">Monthly avg (Forecast Production Date - Signed Plans Received) + 25 days (Melbourne Factory)</div>
          {forecastVsSignedMonthlyWithMelbourneDays.length === 0 ? <div className="text-sm text-slate-500">No rows from current month onward.</div> : <LineChart points={forecastVsSignedMonthlyWithMelbourneDays} color="#047857" />}
        </div>
      </div>
    </>
  );
