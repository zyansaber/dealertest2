import { BarChart3, ChevronLeft, ChevronRight, ClipboardList, Target } from "lucide-react";
import { NavLink } from "react-router-dom";

type PlanningTabPath = "/planningintegration" | "/planningintegration/schedule" | "/planningintegration/waiting-for-ordering" | "/planningintegration/target" | "/planningintegration/report";
...
const navItems: Array<{ path: PlanningTabPath; label: string; icon: typeof ClipboardList; end?: boolean }> = [
  ...
  { path: "/planningintegration/waiting-for-ordering", label: "Waiting for ordering", icon: ClipboardList },
