          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <Card className="border-slate-200 shadow-sm hover:shadow-md transition">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-amber-600">{vanConditionCounts.secondHand}</div>
                </CardContent>
              </Card>
              ...
              <Card className="border-slate-200 shadow-sm hover:shadow-md transition">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-sky-600">{vanConditionCounts.newVans}</div>
                </CardContent>
              </Card>

              <Card className="border-slate-200 shadow-sm hover:shadow-md transition md:col-span-2">
                <CardHeader className="flex items-center justify-between">
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={220}>
                    <BarChart data={yardRangeBuckets}>
                      ...
                      >
                        <LabelList dataKey="newVans" position="top" />
                      </Bar>
                      <Bar dataKey="secondHand" name="Second Hand" stackId="yardType" fill="#f59e0b">
                        <LabelList dataKey="secondHand" position="top" />
                      </Bar>
                    </BarChart>
                  </ResponsiveContainer>
                </CardContent>
