...
export default function WaitingForOrderingPage({
  ...
  const downloadExcel = () => {
    const header = [tr(lang, "Chassis Number", "底盘号"), tr(lang, "Model", "车型"), tr(lang, "Forecast Production Date", "预测生产日期"), tr(lang, "Forecast - Today (days)", "Forecast-今天（天）"), tr(lang, "Status", "状态"), tr(lang, "Price", "价格")];
