  ...
  return (
    <>
      <div className="mb-4 rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <p className="text-sm text-slate-600">Shared monthly target saved to Firebase (2025-06 ~ 2026-12).</p>
      </div>
      ...
      <div className="mb-4 overflow-auto rounded-xl border border-slate-200 bg-white shadow-sm">
        <table className="min-w-[1400px] text-sm">
          <thead className="bg-slate-900 text-white">
            <tr>
              <th className="sticky left-0 z-10 bg-slate-900 px-4 py-3 text-left font-semibold">Shared Target</th>
              {monthsForTargetInput.map((m) => (
                <th key={m} className="px-3 py-3 text-left font-semibold">{m}</th>
              ))}
            </tr>
          </thead>
          <tbody>
            <tr className="border-t border-slate-200 bg-white">
              <td className="sticky left-0 bg-white px-4 py-3 font-medium">All Metrics</td>
