...
type PlanningTabPath = "/planningintegration" | "/planningintegration/schedule" | "/planningintegration/waiting-for-po" | "/planningintegration/target" | "/planningintegration/report";
...
const navItems: Array<{ path: PlanningTabPath; label: string; icon: typeof ClipboardList; end?: boolean }> = [
  ...
  { path: "/planningintegration/waiting-for-po", label: "waiting for PO", icon: ClipboardList },
