  ...
  const outlookRows = useMemo(() => {
    ...
    Object.entries(handoverAll || {}).forEach(([dealerSlug, rows]) => {
      ...
      Object.entries(rows || {}).forEach(([key, payload]) => {
        ...
        // Directly mirror Stock Model Outlook bracket logic: stock is from matched schedule customer.
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="rounded-md border bg-slate-50 p-3 text-sm text-slate-700">
              ...
              requiredBy6m、handover6mStock、handover6mMultiplier、requiredBy3m、handover3mStock、handover3mMultiplier（handover口径直接复用/overall-dashboard的括号stock逻辑：按handover路径dealer + schedule.Customer=stock计数）。
            </div>
