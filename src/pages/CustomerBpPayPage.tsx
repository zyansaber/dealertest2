...
type StatusFilter = "all" | "ok" | "paid-not-registered" | "unpaid-or-not-registered";
            ...
            <CardHeader className="gap-4">
              <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <CardDescription>
                    Sorted by Order Created Date (newest first). Status rules: ±10 is OK; negative is Paid, not registered; positive is Unpaid / not registered.
                  </CardDescription>
                </div>
