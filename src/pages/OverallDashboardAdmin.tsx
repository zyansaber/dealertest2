  ...
  const outlookRows = useMemo(() => {
    ...
    Object.entries(handoverAll || {}).forEach(([dealerSlug, rows]) => {
      Object.entries(rows || {}).forEach(([key, payload]) => {
        ...
        // Align with /overall-dashboard sidebar-filtered Stock Model Outlook behavior:
        // Handover 6m / 3m are counted from handover records in time window (dealer-scoped),
        // not additionally gated by stock-customer inference.
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="rounded-md border bg-slate-50 p-3 text-sm text-slate-700">
              ...
              requiredBy6m、handover6mStock、handover6mMultiplier、requiredBy3m、handover3mStock、handover3mMultiplier（handover口径与/overall-dashboard一致）。
            </div>
