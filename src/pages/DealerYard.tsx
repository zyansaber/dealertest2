                          ...
                          <Fragment key={row.chassis}>
                            <TableRow className={expandedChassis[row.chassis] ? "bg-slate-50/80" : ""}>
                              <TableCell className="font-medium">
                                <button
                                  type="button"
                                  className="inline-flex items-center gap-2 rounded-md border border-slate-500 bg-slate-900 px-2 py-1 text-left text-slate-100 transition hover:border-slate-400 hover:bg-slate-800"
                                  onClick={() =>
