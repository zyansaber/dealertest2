...
export default function OrderDetails({
  ...
  const customerCol = showDeliveryTo ? "col-span-1" : "col-span-2";
  const statusCol = showDeliveryTo ? "col-span-1" : "col-span-2";
  const deliveryToCol = "col-span-2";
  ...
  return (
    <div className="border border-slate-200 rounded-lg">
      ...
      >
        ...
        <div className={`${customerCol} text-slate-700 truncate`}>{order.Customer}</div>
