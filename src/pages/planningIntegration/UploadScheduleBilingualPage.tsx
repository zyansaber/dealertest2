...
export default function UploadScheduleBilingualPage({ lang }: UploadScheduleBilingualPageProps) {
  ...
  const downloadTemplate = () => {
    const templateRows = [
      {
        chassis: "EXAMPLE123",
        "planned chassisWelding": "2026-03-20",
        "planned finishgoods": "2026-04-05",
      },
    ];
    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-slate-600">
          {tr(lang, "Upload one Excel file, pick month, and auto-link by chassis.", "上传一份 Excel，选择月份，并按车架号自动关联。")}
        </p>
      </header>
