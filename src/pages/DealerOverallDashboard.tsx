...
const EXTERNAL_NAMES = ["Green Show", "Slacks Creek", "Forest Glen", "Townsville"];
...
export default function DealerOverallDashboard() {
  ...
  const isGroupAggregate = isFactoryDealerAggregate || isGreenRvAggregate || isNewZealandAggregate;
  ...
  const externalOptions = useMemo(() => buildDealerOptions(EXTERNAL_NAMES), [buildDealerOptions]);
  ...
  const aggregateSlugMap = useMemo(
    ...
    [factoryDealerSlugs, greenRvSlugs, newZealandSlugs]
  );
