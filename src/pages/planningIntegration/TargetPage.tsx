  ...
  return (
    <>
      ...
      <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-3">
        <Card><CardHeader><CardTitle className="text-sm">Total Difference (Actual - Shared Target)</CardTitle></CardHeader><CardContent><p className={`text-3xl font-bold ${totalDifference>=0?"text-emerald-700":"text-rose-700"}`}>{totalDifference}</p><p className="text-xs text-slate-500">Selected metric only · 2025-06 to previous month</p></CardContent></Card>
